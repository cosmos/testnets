...
* **Chain-ID**: `provider`
* **denom**: `uatom`
* **Current Gaia Version**: [`v27.2.0-rc0`](https://github.com/cosmos/gaia/releases/tag/v27.2.0-rc0), upgraded from v27.1.0-rc0 at block height `16776100`.
...
The provider chain will upgrade to Gaia `v27.3.0-rc0` on **May 5, 2026**

* Upgrade height: `17185100`
  * Estimated upgrade time: `13:30 UTC`
  * Mintscan countdown: https://www.mintscan.io/ics-testnet-provider/block/17185100
  * Proposal 300: https://explorer.polypore.xyz/provider/gov/300
* Upgrade name: `v27.3.0`
* Release page: https://github.com/cosmos/gaia/releases/tag/v27.3.0-rc0
...
* When the node reaches height `11934600`, it will attempt to upgrade to Gaia `v24`. You can use Cosmovisor's auto-download feature or install the `v24.0.0-rc0` release binary.
* Before the node reaches height `12039600`, stop the service.
* Set `halt-height = 12039600` in `~/.gaia/config/app.toml` and start the service.
...
* When the node reaches height `16463900`, it will attempt to upgrade to Gaia `v27.1.0`. You can use Cosmovisor's auto-download feature or install the `v27.1.0-rc0` release binary.
* When the node reaches height `16776100`, it will attempt to upgrade to Gaia `v27.2.0`. You can use Cosmovisor's auto-download feature or install the `v27.2.0-rc0` release binary.
