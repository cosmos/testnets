...
* When the node reaches height `TBD`, it will attempt to upgrade to Gaia `v27.1.0`. You can use Cosmovisor's auto-download feature or install the `v27.1.0-rc0` release binary.