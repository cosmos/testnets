#!/bin/bash
# Set up a Cosmovisor service to join the test-upgrade-1 chain.
...
CHAIN_BINARY='gaiad'
CHAIN_ID=test-upgrade-1
GENESIS_URL=https://github.com/cosmos/testnets/raw/master/interchain-security/test-upgrade-1/genesis.json
PEERS="8f5043f62c56fca66653719a514e87fe66dcd145@upgrade-sentry.ics-testnet.polypore.xyz:26656"
SYNC_RPC_1=http://upgrade-sentry.ics-testnet.polypore.xyz:26657
SYNC_RPC_2=http://upgrade-sentry.ics-testnet.polypore.xyz:26657
