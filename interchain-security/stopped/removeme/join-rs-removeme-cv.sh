#!/bin/bash
# Set up a Cosmovisor service to join the removeme chain.
...
GENESIS_URL=https://github.com/cosmos/testnets/raw/master/interchain-security/removeme/removeme-genesis.json
