...
GO_VERSION=1.22.11
STATE_SYNC=false
GAS_PRICE=0.005uhalt
# ***

CHAIN_BINARY='gaiad'
CHAIN_ID=test-halt-1
GENESIS_URL=https://github.com/cosmos/testnets/raw/master/interchain-security/test-halt-1/genesis.json
PEERS="664a04bd4023a561c0cb9bc1f3a9c012c60dd816@halt-sentry.ics-testnet.polypore.xyz:26656"
SYNC_RPC_1=https://rpc.halt-sentry.ics-testnet.polypore.xyz:443
SYNC_RPC_2=https://rpc.halt-sentry.ics-testnet.polypore.xyz:443
