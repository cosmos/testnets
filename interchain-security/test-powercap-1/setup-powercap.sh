#!/bin/bash
# Set up a service for the test-powercap-1 chain.
...
NODE_HOME=~/.powercap
NODE_MONIKER=powercap
SERVICE_NAME=test-powercap-1
SERVICE_DESCRIPTION="test-powercap-1 node"
CHAIN_VERSION="v4.0.0"
GAS_PRICE=0upow
# ***

CHAIN_BINARY='interchain-security-cd'
CHAIN_ID=test-powercap-1
PEERS="5ac39e42f07d373c5544fd487639375f8f57da74@powercap-banana.ics-testnet.polypore.xyz:26656,c0713cf382be88a124ccc29139f2a7aa797403a8@powercap-cherry.ics-testnet.polypore.xyz:26656,7be2d3916cde2d8979fdffd123d0b38321486a95@powercap-node.ics-testnet.polypore.xyz:26656"
