...
* Chain upgrade point: `21th of January 14:30 UTC` at height `23607800`
* Go version: `v1.22`
...
```shell
ERR UPGRADE "v5.0.5" NEEDED at height: 23607800: upgrade to v5.0.5 and applying upgrade "v5.0.5" at height:23607800
```
