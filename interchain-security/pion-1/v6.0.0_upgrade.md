...
* Chain upgrade point: `27th of October 13:30 UTC` at height `<HEIGHT>`
* Go version: `v1.23`
...
```shell
ERR UPGRADE "v6.0.0-rc0" NEEDED at height: 20188400: upgrade to v6.0.0-rc0 and applying upgrade "v6.0.0-rc0" at height:20188400
```
