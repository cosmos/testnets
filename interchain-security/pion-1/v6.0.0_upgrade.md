...
* Chain upgrade point: `27th of March 13:30 UTC` at height `26702000`
* Go version: `v1.23`
* Release: https://github.com/neutron-org/neutron/releases/tag/v6.0.0-rc0
* Reference binary: [neutrond-linux-amd64](neutrond-linux-amd64)
* Binary sha256sum: `ea34724ce90b4a72877e05a08903cf6880139a9399a004196f18431716635cdd`
...
Make sure Neutron v6.0.0-rc0 is installed by either downloading a [compatible binary](https://github.com/neutron-org/neutron/releases/tag/v6.0.0-rc0), or building from source. Building from source requires **Golang 1.23.x**.
