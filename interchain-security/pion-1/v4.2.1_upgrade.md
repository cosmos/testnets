...
```shell
ERR UPGRADE "v4.2.1-testnet" NEEDED at height: 18256000: upgrade to v4.2.1-testnet and applying upgrade "v4.2.1-testnet" at height:h
```
...
TODO: REPLACE "h" with actual values and make sure "v4.2.1-testnet" is the precise version name
```shell
ERR UPGRADE "v4.2.1-testnet" NEEDED at height: 18256000: upgrade to v4.2.1-testnet and applying upgrade "v4.2.1-testnet" at height:h
```
