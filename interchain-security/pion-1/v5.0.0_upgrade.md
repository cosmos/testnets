...
* Chain upgrade point: `16th of October 15:30 UTC` at height `20190500`
* Go version: `v1.22`
...
The Neutron testnet network, `pion-1`, is currently running [Neutron v5.0.0](https://github.com/neutron-org/neutron/releases/tag/v5.0.0). We anticipate that operators who are running on v4.0.1-testnet, will be able to upgrade successfully. Validators are expected to ensure that their systems are up-to-date and capable of performing the upgrade. This includes running the correct binary, or if building from source, building with go `1.22`.

### Target runtime

The Neutron testnet network, `pion-1`, will run [Neutron v5.0.0](https://github.com/neutron-org/neutron/releases/tag/v5.0.0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
- Use a statically built Neutrond binary from an official Neutron release: [https://github.com/neutron-org/neutron/releases/tag/v5.0.0](https://github.com/neutron-org/neutron/releases/tag/v5.0.0)
...
Make sure Neutron v4.2.1-testnet is installed by either downloading a [compatible binary](https://github.com/neutron-org/neutron/releases/tag/v5.0.0), or building from source. Building from source requires **Golang 1.22.x**.

Run Neutron v4.0.1-testnet till upgrade height, the node will panic:

```shell
ERR UPGRADE "v5.0.0" NEEDED at height: 20190500: upgrade to v5.0.0 and applying upgrade "v5.0.0" at height:20190500
```
...
Then the Cosmovisor will create `$NEUTRON_HOME/cosmovisor/upgrades/v4.2.1-testnet/bin` and download the Neuton v5.0.0 binary to this folder according to links in the `--info` field of the upgrade proposal.
...
> neutrond start --unsafe-skip-upgrade 20190500
