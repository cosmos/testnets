...
* **Chain-ID**: `provider`
* **denom**: `uatom`
* **Current Gaia Version**: [`v25.2.0`](https://github.com/cosmos/gaia/releases/tag/v25.2.0), upgraded from v25.1.1 at block height `14571900`.
...
The provider chain will upgrade to Gaia `v25.3.0` on **January 6, 2026**
