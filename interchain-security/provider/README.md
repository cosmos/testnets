...
* **Chain-ID**: `provider`
* **denom**: `uatom`
* **Current Gaia Version**: [`v22.0.0-rc0`](https://github.com/cosmos/gaia/releases/tag/v22.0.0-rc0), upgraded from v21 at block height `10059200`.
...
The provider chain will upgrade to Gaia [v22.0.0](https://github.com/cosmos/gaia/releases/tag/v22.0.0) on **TBD**
