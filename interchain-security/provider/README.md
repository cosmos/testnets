...
* **Chain-ID**: `provider`
* **denom**: `uatom`
* **Current Gaia Version**: [`v17.2.0`](https://github.com/cosmos/gaia/releases/tag/v17.2.0), upgraded from v16 at block height `6380200`.
...
The provider chain will upgrade to Gaia [v17.2.0](https://github.com/cosmos/gaia/releases/tag/v17.2.0) on **TBD**.
