#!/bin/bash
# Set up a service for the test-java-1 chain.
...
NODE_HOME=~/.java
NODE_MONIKER=java
SERVICE_NAME=test-java-1
SERVICE_DESCRIPTION="test-java-1 node"
CHAIN_VERSION="v4.0.0"
GAS_PRICE=0ujava
# ***

CHAIN_BINARY='interchain-security-cd'
CHAIN_ID=test-java-1
PEERS="a1e212b0a31f6a32b1dcf4517c58256f90341681@java-node.isle-testnet.polypore.xyz:26656"
