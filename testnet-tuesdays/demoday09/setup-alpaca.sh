#!/bin/bash
# Set up a service for the test-alpaca-4 chain.
...
NODE_HOME=~/.alpaca
NODE_MONIKER=alpaca
SERVICE_NAME=test-alpaca-4
SERVICE_DESCRIPTION="test-alpaca-4 node"
CHAIN_VERSION="v4.5.0"
GAS_PRICE=0.005upac
# ***

CHAIN_BINARY='interchain-security-cd'
CHAIN_ID=test-alpaca-4
PEERS="9547c9331021e0f076a359b095d01e68a63c89a2@alpaca-apple.ics-testnet.polypore.xyz:26656"
