...
- **Current Gaia Version:** `v14.1.0-rc0` (upgraded from v13 at height `18766800`)
...
If you are **manually preparing your binary**, please set the environment variable `DAEMON_ALLOW_DOWNLOAD_BINARIES=false` and download a copy of the v14.1.0-rc0 binary to the v14 upgrade directory in your cosmovisor directory (`upgrades/v14/bin/gaiad`). 
