#!/bin/bash
# Set up a Cosmovisor service to join the noble-1 chain.
...
CHAIN_ID=noble-1
SEEDS=""
SYNC_RPC_1=https://noble1-state-sync-01.noble.ics-testnet.strange.love:443
SYNC_RPC_2=https://noble1-state-sync-02.noble.ics-testnet.strange.love:443
