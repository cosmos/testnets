...
The provider chain will upgrade to Gaia [v16.0.0-rc0](https://github.com/cosmos/gaia/releases/tag/v16.0.0-rc0) on **TBD**. Details will be posted below when an upgrade height is assigned.
