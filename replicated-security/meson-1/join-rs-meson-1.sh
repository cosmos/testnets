#!/bin/bash
# Set up a service to join the meson-1 chain.
...
CHAIN_ID=meson-1
SEEDS="e2c07e8e6e808fb36cca0fc580e31216772841df@p2p-palvus.meson-1.ntrn.tech:26656"
SYNC_RPC_1=https://rpc-lb.meson-1.ntrn.tech:443
...
GENESIS_URL=https://github.com/cosmos/testnets/raw/master/replicated-security/meson-1/meson-1-genesis.json
