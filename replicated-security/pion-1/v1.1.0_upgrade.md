...
The Neutron mainnet network, `neutron-1`, will run [Neutron v1.1.0](TODO: ADD A LINK TO THE RELEASE). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
The upgrade may take a few minutes to several hours to complete because neutron-1 participants operate globally with differing operating hours and it may take some time for operators to upgrade their binaries and connect to the network.
