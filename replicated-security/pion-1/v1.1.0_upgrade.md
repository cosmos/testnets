...
* Chain upgrade point: `29th of November 15:30 UTC`;
* Go version: `v1.20`
* Release: https://github.com/neutron-org/neutron/releases/tag/v1.1.0

This document describes the steps for validators and full node operators, to upgrade successfully to the Neutron v1.1.0 release. For more details on the release, please see the [release notes](https://github.com/neutron-org/neutron/releases/tag/v1.1.0).

## Upgrade date

The upgrade will take place approximately at `15:30 UTC`;
...
The Neutron testnet network, `pion-1`, will run [Neutron v1.1.0](https://github.com/neutron-org/neutron/releases/tag/v1.1.0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
Make sure Neutron v1.1.0 is installed by either downloading a [compatible binary](https://github.com/neutron-org/neutron/releases/tag/v1.1.0), or building from source. Building from source requires **Golang 1.20.x**.

Run Neutron v1.0.4 till upgrade height, the node will panic:

```shell
ERR UPGRADE "v1.1.0" NEEDED at height: %%HEIGHT%%: upgrade to v1.1.0 and applying upgrade "v1.1.0" at height:h
```
