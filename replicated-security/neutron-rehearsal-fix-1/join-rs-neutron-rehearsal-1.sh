#!/bin/bash
# Set up a service to join the neutron-rehearsal-fix-1 chain.
...
NODE_HOME=~/.neutrond
NODE_MONIKER=neutron-rehearsal-fix-1
...
GENESIS_URL=https://github.com/cosmos/testnets/raw/master/replicated-security/neutron-rehearsal-fix-1/neutron-rehearsal-fix-1-genesis.json
