...
The Release testnet (`theta-testnet-001`) is upgraded to the release candidate firs; and after it is confirmed as successful, the Replicated Security testnet (`provider`) is upgraded next.
